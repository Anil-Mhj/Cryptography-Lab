// c program to illustrate key generation functioning of AES
#include <stdio.h>
#include <stdint.h>
...
int main()
{
    ...
    printf("Enter 16-byte key (hex values):\n");
    printf("Example: 2B 7E 15 16 28 AE D2 A6 AB F7 15 88 09 CF 4F 3C\n\n");
